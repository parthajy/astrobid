      ...
      <div className="mx-auto max-w-4xl px-4">
        ...
        <div className="mt-6 space-y-2">
          {configured && rows.length === 0 && (
            <p className="text-sm text-white/30">No past launches yet. Check back soon.</p>
          )}
          {rows.map((r) => (
            <div
              key={r.date}
            ...
            >
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  <span className="truncate text-base font-bold text-white">{r.product_name}</span>
              ...
              <div className="flex items-center gap-3">
                <span className="text-lg font-extrabold text-violet-200 glow-soft">
                  {money(r.bid_amount)}
                </span>
